...
function createHandler(opts) {
    ...
    console.log("oldIstanbul assetsDir :")
    console.log(oldistanbul.ASSETS_DIR)

    console.log("oldIstanbul : ")
    console.log(oldistanbul)


    console.log("istanbul-lib-instrument :")
    console.log(istanbul)

    console.log("ASSERTS DIR")
